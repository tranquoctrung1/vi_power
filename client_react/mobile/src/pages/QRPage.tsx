...
export default function QRPage() {
  ...
  function parseDeviceId(raw: string): string | null {
    ...
    if (/^[A-Za-z0-9_\-]{4,64}$/.test(trimmed)) return trimmed.toLowerCase();
    return null;
  }
        ...
        {scanState === "idle" && (
          ...
          >
            <i
              ...
              style={{ fontSize: 64, color: "#38aaff", marginBottom: 16 }}
            />
            <div
              style={{
                fontSize: 14,
            ...
            <div style={{ marginTop: 28, width: "100%", maxWidth: 320 }}>
              ...
              >
                hoặc nhập mã thiết bị thủ công
              </div>
              ...
              {scanState === "found" ? (
                <>
                  <i
                    ...
                    style={{ color: "#22d369" }}
                  />{" "}
                  Đã nhận diện! Đang chuyển hướng...
                </>
              ) : (
        ...
        {scanState === "error" && (
          ...
          >
            <i
              ...
              style={{ fontSize: 48, color: "#f44b4b", marginBottom: 16 }}
            />
            <div
              style={{
                fontSize: 14,
