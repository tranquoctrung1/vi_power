...
const alertController = {
    ...
    async createAlert(req, res) {
        try {
            ...
            socketManager.broadcast({ type: 'new_alert', data: alert });
    ...
    async getAllAlerts(req, res) {
        try {
            ...
            const result = await AlertModel.findAll(filter, options);
    ...
    async getUnresolvedAlerts(req, res) {
        try {
            ...
            const alerts = await AlertModel.findUnresolved({}, parseInt(limit));
    ...
    async updateAlert(req, res) {
        try {
            ...
            const result = await AlertModel.update(id, updateData);
    ...
    async deleteAlert(req, res) {
        try {
            ...
            const result = await AlertModel.delete(id);
    ...
    async getAlertStats(req, res) {
        try {
            ...
            const stats = await AlertModel.getStats(period);
