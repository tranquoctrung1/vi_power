...
const displayGroupController = {
  ...
  async createDisplayGroup(req, res) {
    try {
      ...
      const group = await DisplayGroupModel.create(db, groupData);
  ...
  async getDisplayGroupById(req, res) {
    try {
      ...
      const group = await DisplayGroupModel.findById(db, id);
  ...
  async getAllDisplayGroups(req, res) {
    try {
      ...
      const groups = await DisplayGroupModel.findAll(db, filter);
  ...
  async updateDisplayGroup(req, res) {
    try {
      ...
      const result = await DisplayGroupModel.update(db, id, updateData);
  ...
  async deleteDisplayGroup(req, res) {
    try {
      ...
      const result = await DisplayGroupModel.delete(db, id);
