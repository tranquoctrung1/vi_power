...
const authController = {
  ...
  async changePassword(req, res) {
    try {
      ...
      await UserModel.update(db, userId, { password: newPassword });
  ...
  async getAllUsers(req, res) {
    try {
      ...
      const result = await UserModel.findAll(db, filter, options);
  ...
  async updateUser(req, res) {
    try {
      ...
      const result = await UserModel.update(db, id, updateData);
  ...
  async deleteUser(req, res) {
    try {
      ...
      const result = await UserModel.delete(db, id);
